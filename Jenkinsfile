...
@Library('github.com/rajkris2/jenkins-pipeline')

def pipeline = new com.mimir2.Pipeline()

podTemplate(label: 'jenkins-pipeline', containers: [
    containerTemplate(name: 'docker-k8s-helm', image: 'rajakrish82/docker-k8s-helm:v1', command: 'cat', ttyEnabled: true)
],
volumes:[
  ...
  node ('jenkins-pipeline') {
    ...
    def pwd = pwd()
    def chart_dir = "${pwd}/charts/HelloNodeJS-Chart"
